...
| 환경    | 클러스터 | 구성 방법                                  |
| ------- | -------- | ------------------------------------------ |
| dev     | kubeadm  | 이 레포 (302-goormgb-k8s-bootstrap)        |
| staging | EKS      | 301-goormgb-terraform (EKS Blueprint)      |
| prod    | EKS      | 301-goormgb-terraform (EKS Blueprint)      |
...
```bash
git clone git@github.com:goorm-gongbang/302-goormgb-k8s-bootstrap.git
...
| 레포 | 용도 |
| ---- | ---- |
| [301-goormgb-terraform](https://github.com/goorm-gongbang/301-goormgb-terraform) | EKS 클러스터 (staging/prod) - EKS Blueprint |
| **302-goormgb-k8s-bootstrap** | kubeadm 부트스트랩 (dev) |
